...
class TripletLattice:
    ...
    def elements(self):
        ...
        return [
            ...
            Edge(self.tF - self.BF, rhoF),
            Fringe(self.tF - self.BF, rhoF, r1, self.ffl, self.k),
            Fringe(self.tF - self.BF, rhoD, r3, self.dfl, self.k),
            Edge(self.tF - self.BF, rhoD),
            dMag,
            Edge(self.tC-self.BF-self.BD, rhoD),
            Fringe(self.tC-self.BF-self.BD, rhoD, r3, self.dfl, self.k),
            cdrift,
            cdrift2,
            Fringe(self.tC-self.BF-self.BD, rhoD, r3, self.dfl, self.k),
            Edge(self.tC-self.BF-self.BD, rhoD),
